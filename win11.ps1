# To run, boot OSDCloudUSB, at the PS Prompt: iex (irm win11.yarrall.com)
$ScriptName = 'win11.yarrall.com'
$ScriptVersion = '1.0'
...
write-host "OSDCloud Process Complete. Rebooting in 10 seconds" -ForegroundColor Green
